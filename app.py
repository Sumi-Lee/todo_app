...
#     todo.done = not todo.done # True / False 반전
#
# # todos 초기화
...
#         col1, col2 = st.columns([0.2, 0.8]) # 비율로 지정 가능
#         col1.checkbox(f"done_{i}", value=todo.done, key=f"done_{i}", on_change = toggle_done, args=(i,))
